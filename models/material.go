...
type Material struct {
	MaterialID      string `json:"item_id" gorm:"unique"` //物料编号
	MaterialName    string `json:"item_name"`             //物料名称
	...
	ResNumber       string `json:"number"`                // 库存余结
	WarnNumber      string `json:"warn_number"`           // 预警值
}

func (MaterialSql) TableName() string {
	return "material_sql"
}
